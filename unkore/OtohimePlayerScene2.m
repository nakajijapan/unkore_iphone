...
#import "OtohimePlayerScene2.h"


@implementation OtohimePlayerScene2
...
-(id) init
{
    ...
    if (self) {
        ...
        // 背景画像
        CCSprite* uiframe = [CCSprite spriteWithFile:@"kotori_background.png"];
        ...
        // 再生ボタン
        CCMenuItemImage* menuSoundStart = [CCMenuItemImage itemWithNormalImage:@"kotori_btn_start.png" selectedImage:nil];
        _menuSoundStop = [CCMenuItemImage itemWithNormalImage:@"kotori_btn_stop.png" selectedImage:nil];
...
+(id)scene
{
	...
	OtohimePlayerScene2* layer = [OtohimePlayerScene2 node];
...
-(void) onSoundCallback:(id)sender
{
    ...
    if ([sender selectedIndex] == 1) {
        [[SimpleAudioEngine sharedEngine] playBackgroundMusic:@"unkore_otohime001.mp3"];
