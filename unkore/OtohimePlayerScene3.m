...
#import "OtohimePlayerScene3.h"


@implementation OtohimePlayerScene3
...
-(id) init
{
    ...
    if (self) {
        ...
        // Musicのプレリロード
        [[SimpleAudioEngine sharedEngine] preloadBackgroundMusic:@"unkore_otohime003.mp3"];
        
        // 背景画像
        CCSprite* uiframe = [CCSprite spriteWithFile:@"maoh_background.png"];
        ...
        // 再生ボタン
        CCMenuItemImage* menuSoundStart = [CCMenuItemImage itemWithNormalImage:@"maoh_btn_start.png" selectedImage:nil];
        _menuSoundStop = [CCMenuItemImage itemWithNormalImage:@"maoh_btn_stop.png" selectedImage:nil];
...
+(id)scene
{
	...
	OtohimePlayerScene3* layer = [OtohimePlayerScene3 node];
...
-(void) onSoundCallback:(id)sender
{
    ...
    if ([sender selectedIndex] == 1) {
        [[SimpleAudioEngine sharedEngine] playBackgroundMusic:@"unkore_otohime003.mp3"];
